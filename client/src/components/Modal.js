            ...
            <div className="py-12 bg-gray-700 transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0" id="modal">
                <div role="alert" className="container mx-auto w-11/12 md:w-2/3 max-w-lg">
                    <div className="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
                        ...
                        <input id="name" value={employeeInfo.name} onChange={handleChange} className="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="Enter employee's name" />
						<label for="email" className="text-gray-800 text-sm font-bold leading-tight tracking-normal">Email ID</label>
                        <input id="email" value={employeeInfo.email} onChange={handleChange} className="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="Enter employee's email ID" />
                        <label for="contact" className="text-gray-800 text-sm font-bold leading-tight tracking-normal">Contact Number</label>
                        <input id="contact" value={employeeInfo.contact} onChange={handleChange} className="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="Enter employee's contact no." />
                        <label for="department" className="text-gray-800 text-sm font-bold leading-tight tracking-normal">Department</label>
                        <input id="department" value={employeeInfo.department} onChange={handleChange} className="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="Enter employee's department" />
                        <label for="joining-date" className="text-gray-800 text-sm font-bold leading-tight tracking-normal">Joining Date</label>
                        <input id="joining-date" value={employeeInfo.joiningDate} onChange={handleChange} className="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="Enter employee's joining date" />
